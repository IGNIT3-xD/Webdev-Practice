...
import { FaBicycle, FaBiking, FaFirstOrder, FaUserShield } from 'react-icons/fa';
...
const Dashboard = () => {
    ...
    return (
        <div className="drawer lg:drawer-open">
            <title>ZapShift - Dashboard</title>
            ...
            <div className="drawer-content">
                ...
                <nav className="navbar w-full bg-base-300">
                    ...
                    <div className="px-4 font-medium">ZapShift Dashboard</div>
                </nav>
                {/* Page content here */}
                <div className='px-6'>
                    <Outlet />
                    ...
                    <ul className="menu w-full grow space-y-3">
                        ...
                        </li>
                        {
                            role === 'Admin' && <>
                                ...
                                <li>
                                    <NavLink to={'/dashboard/users-managment'} className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Users Managment">
                                        <FaUserShield />
                        ...
                        }
                        {
                            role === 'Rider' && <>
                                <li>
                                    <NavLink to={'/dashboard/assign-deliveries'} className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Assign Deliveries">
                                        <FaBicycle />
